...
from Medoy.dB import stickers
from Medoy.dB.forcesub_db import get_forcesetting
from Medoy.dB.gban_mute_db import is_gbanned
from Medoy.dB.greetings_db import get_goodbye, get_welcome, must_thank
from Medoy.fns.helper import inline_mention
from Medoy.fns.tools import create_tl_btn
...
try:
    ...
    detector = None
from . import LOG_CHANNEL, LOGS, asst, Medoy-bot, get_string, types, udB
from ._inline import something


@MEDOY-bot.on(events.ChatAction())
...
"""
@Medoy-bot.on(events.NewMessage(incoming=True))
...
@Medoy-bot.on(events.Raw(types.UpdateUserName))
