...
from Medoy.fns.google_image import googleimagesdownload
from Medoy.fns.tools import metadata
...
@Medoy_cmd(pattern="q( (.*)|$)", manager=True, allow_pm=True)
async def quott_(event):
    ...
    message = await reply.reply("Quotly by Medoy-Ubot", file=file)
    os.remove(file)
    await msg.delete()
    return message
