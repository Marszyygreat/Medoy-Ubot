...
from . import eod, eor, get_string, mediainfo, Medoy_cmd
...
@Medoy_cmd(pattern="setbio( (.*)|$)", fullsudo=True)
async def _(ayra):
    ok = await ayra.eor("...")
...
@Medoy_cmd(pattern="setname ?((.|//)*)", fullsudo=True)
async def _(ayra):
    ok = await ayra.eor("...")
...
@Medoy_cmd(pattern="setfp$", fullsudo=True)
async def _(ayra):
...
@Medoy_cmd(pattern="delfp( (.*)|$)", fullsudo=True)
