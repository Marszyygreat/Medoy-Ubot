...
from Medoy.version import __version__ as KazuVer
...
def MEDOYPIC():
    return inline_pic() or choice(Medoy_IMAGES)


buttons = [
    [
        Button.url(get_string("bot_3"), "https://github.com/Marszyygreat/Medoy-Ubot"),
        Button.url(get_string("bot_4"), "t.me/mutualanonlyone"),
    ]
]
...
async def alive(event):
    text = alive_txt.format(Medoy_version, MedoyVer, __version__)
