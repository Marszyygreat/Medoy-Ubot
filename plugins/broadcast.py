...
from Medoy.dB.gcast_blacklist_db import add_gblacklist, list_bl, rem_gblacklist
...
@Medoy_cmd(pattern="[Gg][c][a][s][t]( (.*)|$)", fullsudo=false)
...
@Medoy_cmd(pattern="[gG][u][c][a][s][t]( (.*)|$)", fullsudo=false)
