...
# t.me/mutualanonlyonet & t.me/Siid0yyy
...
async def _(pong):
    ...
    await kping.edit("**SEMUANYA MINGGIR MEDOY MAU LEWAT.....**")
    end = datetime.now()
    duration = (end - start).microseconds / 1000
    await kping.edit("😎")
    sleep(3)
