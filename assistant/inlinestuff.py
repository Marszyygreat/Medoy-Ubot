...
from Medoy.fns.misc import google_search
...
from . import *
from . import _Medoy_cache

SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="https://github.com/Marszyygreat/Medoy-Ubot.git"),
        Button.url("• Support •", url="@mutualanonlyone"),
    ],
]
...
async def repo(e):
    res = [
        await e.builder.article(
            ...
            thumb=wb(Medoypic, 0, "image/jpeg", []),
            text="**◈ Medoy-ᴜʙᴏᴛ​ ◈**",
            buttons=SUP_BUTTONS,
        ),
    ]
    await e.answer(res, switch_pm="Medoy Repo.", switch_pm_param="start")
...
InlinePlugin.update(
    {
        ...
        "Sᴇᴀʀᴄʜ Oɴ Gᴏᴏɢʟᴇ": "go KegabutanDoy",
        "WʜɪSᴘᴇʀ": "wspr @username Hello🎉",
        "YᴏᴜTᴜʙᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ": "yt Ed Sheeran Perfect",
        "Piston Eval": "run javascript console.log('Hello Medoy')",
        "OʀᴀɴɢᴇFᴏx🦊": "ofox beryllium",
        "Tᴡɪᴛᴛᴇʀ Usᴇʀ": "twitter KegabutanDoy",
