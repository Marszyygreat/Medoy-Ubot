...
from Medoy._misc._decorators import compile_pattern, Medoy_cmd
...
ALIVE_NAME = Medoy-bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = catub = friday = Medoy-bot
catub.cat_cmd = Medoy_cmd
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Medoy")
