...
OWNER = Medoy-bot.full_name

MSG = f"""
**Medoy-ᴜʙᴏᴛ​**
➖➖➖➖➖➖➖➖➖➖
**Owner**: [{OWNER}](tg://user?id={Medoy-bot.uid})
**Support**: @KegabutanDoy
➖➖➖➖➖➖➖➖➖➖
"""
...
IN_BTTS = [
    [
        Button.url(
            "Repository",
            url="https://github.com/Marszyygreat/Medoy-Ubot",
        ),
        Button.url("Support", url="https://t.me/mutualanonlyone"),
    ]
]
...
def callback(data=None, from_users=[], admins=False, owner=False, **kwargs):
    ...
    if "me" in from_users:
        ...
        from_users.append(Medoy-bot.uid)
            ...
            if owner and event.sender_id not in owner_and_sudos():
                res = [
                    await event.builder.article(
                        title="Medoy-ᴜʙᴏᴛ​",
                        url="​https://t.me/mutualanonlyone",
                    ...
                    await event.answer(
                        [
                            await event.builder.article(
                                ...
                                text=error_text(),
                                buttons=Button.url(
                                    "Report", "https://t.me/KegabutanDoy"
                                ),
                            )
                        ]
                    )
