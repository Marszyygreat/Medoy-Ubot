...
#
"""Userbot module for managing events. One of the main components of the userMedoy-bot."""
...
from Medoy import Medoybot
from Medoy._misc._supporter import CMD_HNDLR, CMD_HELP
from Medoy.dB import DEFAULT, DEVLIST
...
def command(**args):
    ...
    def decorator(func):
        ...
        if allow_edited_updates:
            Medoy-bot.add_event_handler(func, events.MessageEdited(**args))
        Medoy-bot.add_event_handler(func, events.NewMessage(**args))
    ...
    def decorator(func):
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    text = "**✘ Medoy-UBOT ERROR REPORT ✘**\n\n"
                    link = "[Group Support](https://t.me/mutualanonlyone)"
                    ...
                    ftext += "\ncukup forward saja pesan ini ke KegabutanDoy"
                    ftext += "\n================================\n\n"
        ...
        if kazu_bot:
            if not disable_edited:
                Medoy-bot.add_event_handler(wrapper, events.MessageEdited(**args))
            Medoy-bot.add_event_handler(wrapper, events.NewMessage(**args))
        return wrapper
